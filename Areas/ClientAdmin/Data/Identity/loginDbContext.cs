...
namespace HairDemoSite.Areas.ClientAdmin.Data.Identity
{
    public partial class LoginDbContext : IdentityDbContext<IdentityUser>
    {
        public LoginDbContext()
        {
        }

        public LoginDbContext(DbContextOptions<IdentityDbContext> options)
            : base(options)
        {
        }
